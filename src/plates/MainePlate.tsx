...
export default function MainePlate(props: PlateProps) {
  ...
  return (
    ...
    >
      ...
      <MaineIllustration />
      <rect x="17" y="17" width="966" height="466" rx="30" fill="none" stroke="#242826" strokeWidth="10" />
      <rect x="23" y="23" width="954" height="454" rx="25" fill="none" stroke="#9fa9a2" strokeWidth="4" />
      <rect x="9" y="9" width="982" height="482" rx="35" fill="none" stroke={`url(#me-rim-${id})`} strokeWidth="5" />
    </BaselinePlate>
  );
}
