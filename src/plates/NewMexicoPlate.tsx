...
export default function NewMexicoPlate(props: PlateProps) {
  return (
    ...
    >
      ...
      <rect x="16" y="15" width="967" height="468" rx={PLATE_INSET_RADIUS} stroke="#165869" strokeWidth="19" fill="none"/>
      <rect x="16" y="15" width="967" height="468" rx={PLATE_INSET_RADIUS} stroke="#e5d552" strokeWidth="10" fill="none"/>
      <rect x="16" y="15" width="967" height="468" rx={PLATE_INSET_RADIUS} stroke="#fff378" strokeWidth="3" fill="none"/>
    </BaselinePlate>
  );
}
